...
extras_require = {
    ...
    # bqm support
    'bqm': ['dimod>=0.9.0,<0.13,!=0.10.0,!=0.10.1,!=0.10.2,!=0.10.3,!=0.10.4', 'numpy>=1.16'],

    # dqm support
    'dqm': ['dimod>=0.9.7,<0.13,!=0.10.0,!=0.10.1,!=0.10.2,!=0.10.3,!=0.10.4', 'numpy>=1.16'],

    # cqm support
    'cqm': ['dimod>=0.10.5,<0.13', 'numpy>=1.16'],
