...
def solver_data(**kwargs):
    """Mock solver for which problem mock replies below make sense."""
...
def complete_reply(id=None, solver_id=None, answer=None, msg=None, label=None):
...
def complete_no_answer_reply(id=None, solver_id=None, label=None):
...
def error_reply(id=None, solver_id=None, error_message=None, label=None):
...
def cancel_reply(id=None, solver_id=None, label=None):
...
def continue_reply(id=None, solver_id=None, now=None, label=None):
